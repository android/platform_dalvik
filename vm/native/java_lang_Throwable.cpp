 ...
 */
static void Dalvik_java_lang_Throwable_nativeFillInStackTrace(const StackSlot* args,
    JValue* pResult)
{
 ...
 */
static void Dalvik_java_lang_Throwable_nativeGetStackTrace(const StackSlot* args,
    JValue* pResult)
{
