...
public class InvokeCustom extends Super {
  ...
  private static void test9CheckStaticField(MethodHandle getter, MethodHandle setter)
      throws Throwable {
    ...
    System.out.print("test9CheckStaticField: old " + oldValue + " new " + newValue +
                     " expected " + NEW_VALUE + " ");
  ...
  private void test9CheckField(MethodHandle getter, MethodHandle setter)
      throws Throwable {
    ...
    System.out.print("test9CheckField: old " + oldValue + " new " + newValue +
                     " expected " + NEW_VALUE + " ");
    System.out.println((newValue == NEW_VALUE) ? "OK" : "ERROR");
  }
  ...
  public static CallSite bsmLookupTest9(MethodHandles.Lookup caller, String name, MethodType type,
    ...
    test9CheckStaticField(staticGetter, staticSetter);
    InvokeCustom instance = new InvokeCustom();
    instance.test9CheckField(fieldGetter, fieldSetter);
