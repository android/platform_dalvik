...
public final class DexFormat {
    ...
    public static final int API_DEFINE_DEFAULT_INTERFACE_METHODS = 24;

    /** API level to target in order to invoke default and static interface methods */
    public static final int API_INVOKE_DEFAULT_INTERFACE_METHODS = 20;
    ...
    public static int magicToApi(byte[] magic) {
        ...
        if (version.equals(VERSION_FOR_API_13)) {
            ...
            return API_DEFINE_DEFAULT_INTERFACE_METHODS;
    ...
    public static String apiToMagic(int targetApiLevel) {
        ...
        } else if (targetApiLevel >= API_DEFINE_DEFAULT_INTERFACE_METHODS) {
