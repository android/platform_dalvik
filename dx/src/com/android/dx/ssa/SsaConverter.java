...
public class SsaConverter {
     ...
     * <li> block has multiple successors and the successor block has multiple predecessors.
     * </ul></p>
     *
    ...
    private static boolean needsNewSuccessor(SsaBasicBlock block,
        ...
        // This is to address b/69128828 where a phi was being converted to move instruction
        // in a block with multiple successors. The move insertion was positioned before the
        // first instruction in the block so tainted other successors. The generated bytecode
        // was rejected by the ART verifier.
