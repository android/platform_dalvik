...
import com.android.dx.command.dexer.Context;
...
public class CfTranslator {
     ...
     */
    public static ClassDefItem translate(Context context, DirectClassFile cf, byte[] bytes,
     ...
     * @return {@code non-null;} the translated class
     */
    private static ClassDefItem translate0(Context context, DirectClassFile cf, byte[] bytes,
                                           CfOptions cfOptions, DexOptions dexOptions, DexFile dexFile) {
     ...
     * @param dexFile {@code non-null;} dex output
     */
    private static void processMethods(Context context, DirectClassFile cf, CfOptions cfOptions,
     ...
     */
    private static void updateDexStatistics(Context context, CfOptions cfOptions, DexOptions dexOptions,
